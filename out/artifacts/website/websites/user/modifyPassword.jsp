    ...
    <c:forEach items="${UserList}" var="user">
        <div class="row clearfix">
            ...
            <div class="col-md-8 column">
                <form class="form-horizontal" action="/servlet/UserAlterServlet?userId=${user.userId}" method="post"
                      onsubmit="return formCheck();" name="password">
                    <input type="hidden" name="flag" value="alterpassword"/>
